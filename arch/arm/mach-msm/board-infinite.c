...
static struct platform_device *infinite_devices[] __initdata = {
	&msm_8960_q6_lpass,
	&msm_8960_q6_mss_fw,
	&msm_8960_q6_mss_sw,
	&msm_8960_riva,
...
static void __init samsung_infinite_init(void)
{
#ifdef CONFIG_SEC_DEBUG
	sec_debug_init();
#endif
	...
	platform_add_devices(infinite_devices, ARRAY_SIZE(infinite_devices));
	msm8960_init_hsic();
	msm8960_init_cam();
	msm8960_init_mmc();
...
MACHINE_START(INFINITE, "SAMSUNG INFINITE")
	.map_io = msm8960_map_io,
	.reserve = msm8960_reserve,
	.init_irq = msm8960_init_irq,
	.handle_irq = gic_handle_irq,
	.timer = &msm_timer,
	.init_machine = samsung_infinite_init,
