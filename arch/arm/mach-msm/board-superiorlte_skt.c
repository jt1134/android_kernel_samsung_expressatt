...
#endif
#ifdef CONFIG_BATTERY_SAMSUNG_STRETTO
#include <linux/power/max77693_battery.h>
#endif
...
#include <linux/power/max17047_fuelgauge.h>
#endif
...
#ifdef CONFIG_LEDS_MAX77693
static void max77693_led_hw_init(void)
{
	int rc;
	...
	rc = pm8xxx_gpio_config(PM8921_GPIO_PM_TO_SYS
		(PMIC_GPIO_TORCH_EN), &param_flash);
	...
	rc = pm8xxx_gpio_config(PM8921_GPIO_PM_TO_SYS
		(PMIC_GPIO_FLASH_EN), &param_flash);
...
static struct max77693_led_platform_data max77693_led_pdata = {
	.hw_init = max77693_led_hw_init,
	.torch_en = PM8921_GPIO_PM_TO_SYS(PMIC_GPIO_TORCH_EN),
	.flash_en = PM8921_GPIO_PM_TO_SYS(PMIC_GPIO_FLASH_EN),
	.num_leds = 4,
...
struct platform_device fuelgauge_i2c_gpio_device = {
	.name = "i2c-gpio",
	.id = MSM_FUELGAUGE_I2C_BUS_ID,
	.dev.platform_data = &fuelgauge_i2c_gpio_data,
};
...
static struct max17047_platform_data max17047_pdata = {
	.hw_init = max17047_hw_init,
};

/* I2C14 */
static struct i2c_board_info fg_i2c_board_info[] __initdata = {
	{
		I2C_BOARD_INFO("max17047-fuelgauge", (0x6C>>1)),
...
#endif
#if defined(CONFIG_BATTERY_MAX17047_FUELGAUGE)
	struct i2c_registry msm8960_fg_i2c_devices = {
		I2C_SURF | I2C_FFA | I2C_FLUID,
		MSM_FUELGAUGE_I2C_BUS_ID,
		fg_i2c_board_info,
...
static int secjack_gpio_init()
{
	...
	rc = gpio_request(GPIO_EAR_DET, "EAR_DET");
	if (rc) {
		pr_err("%s: EAR_DET gpio %d request"
				"failed\n", __func__, GPIO_EAR_DET);
		return rc;
	}
